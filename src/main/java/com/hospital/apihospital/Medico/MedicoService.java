        ...
        if (medicoOptional.isPresent()) {
            ...
            if (datosActualizarMedico.direccion() != null) {
                ...
                if (datosActualizarMedico.direccion().carrera() != null) {
                    ...
                    direccion.setCarrera(medico.getDireccion().getCarrera());
                }
                if (datosActualizarMedico.direccion().complemento() != null) {
                    ...
                    direccion.setComplemento(medico.getDireccion().getComplemento());
                }
                if (datosActualizarMedico.direccion().letraComplemento() != null) {
                    ...
                    direccion.setLetraComplemento(medico.getDireccion().getLetraComplemento());
                }
